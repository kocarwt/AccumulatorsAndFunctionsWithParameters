...
def main():
    ...
    run_test_better_draw_circles(rg.Point(250, 250), 5)
    run_test_even_better_draw_circles(rg.Point(250, 250), 5, 21, .05, 1)
...
def run_test_better_draw_circles(center, radius):
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles:  See graphics window')
    print('--------------------------------------------------')
    better_draw_circles(center, radius)


def better_draw_circles(center, radius):
...
def run_test_even_better_draw_circles(center, radius, ranges, speed, thickness):
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles:  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(center, radius, ranges, speed, thickness)


def even_better_draw_circles(center, radius, ranges, speed, thickness):
    window = rg.RoseWindow(500, 500)

    for k in range(ranges):
        circle = rg.Circle(center, radius * k)
        circle.pen = rg.Pen('red', thickness*k )
        circle.attach_to(window)
        window.render(speed * k)
